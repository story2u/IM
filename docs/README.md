...
- [Telegram 原生连接](integrations/telegram.md)：连接方式、Bot webhook、部署变量与旧配置兼容。
- [Demo 资产 Runbook](demo/recording-runbook.md)：安全演示数据、截图、录屏、Remotion 与 Release 资产。
- [Demo 中文脚本](demo/demo-script.zh-CN.md)、[英文脚本](demo/demo-script.en.md)、
  [截图清单](demo/screenshot-list.md)、[Release 模板](releases/demo-release-template.md)。
- [统一订阅 Runbook](integrations/revenuecat-paddle-billing.md)：RevenueCat、Paddle 与商店人工配置、验收和回滚。
