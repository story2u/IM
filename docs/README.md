...
- [企业微信消息收发](integrations/wecom.md)：自建应用单聊、会话存档边界、安全与分阶段实现。
- [企业微信会话内容存档](integrations/wecom-conversation-archive.md)：企业级授权、成员绑定、增量拉取与数据隔离。
- [统一订阅 Runbook](integrations/revenuecat-paddle-billing.md)：RevenueCat、Paddle 与商店人工配置、验收和回滚。
- [密码修改与邮箱重置](integrations/password-reset.md)：一次性挑战、SMTP 配置、会话吊销与上线检查。
