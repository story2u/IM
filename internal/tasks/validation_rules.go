...
var validTaskTypes = map[string]bool{
	...
	"video_call":                       true,
	"hangup_call":                      true,
	"prepare_call_audio_output":        true,
	"rpa_voice_call":                   true,
	"rpa_video_call":                   true,
...
var taskRequiredPayloadFields = map[string][]string{
	...
	"voice_call":                       {"username", "receiver", "call_type"},
	"video_call":                       {"username", "receiver", "call_type"},
	"hangup_call":                      {"username", "receiver"},
	"prepare_call_audio_output":        {"username"},
