	...
	return []Profile{
		...
		},
		{
			...
			Routes: []RouteRequirement{
				...
				{Method: "POST", Path: "/api/v1/agents/connectors/login/event"},
				{Method: "POST", Path: "/api/v1/connectors/sessions/qrcode"},
				{Method: "POST", Path: "/api/v1/connectors/sessions/verify-code"},
				{Method: "POST", Path: "/api/v1/connectors/sessions/logout"},
				{Method: "GET", Path: "/api/v1/connectors/sessions/status"},
				{Method: "GET", Path: "/api/v1/connectors/user-info/last"},
				{Method: "POST", Path: "/api/v1/connectors/user-info/request"},
				{Method: "GET", Path: "/api/v1/connectors/user-info/candidates"},
				...
				{Method: "POST", Path: "/api/v1/devices/{device_id}/apps/open"},
				{Method: "POST", Path: "/api/v1/devices/{device_id}/apps/stop"},
